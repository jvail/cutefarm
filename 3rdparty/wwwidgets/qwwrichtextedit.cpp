 ...
 */
QwwRichTextEdit_::QwwRichTextEdit_(QWidget *parent) : QTextEdit(parent){
    currentList = 0;
    ...
    m_actions[BoldAction] = new QAction(QIcon(QPixmap(":/trolltech/formeditor/images/win/textbold.png")), tr("Bold"), this);
    ...
    m_actions[ItalicAction] = new QAction(QPixmap(":/trolltech/formeditor/images/win/textitalic.png"), tr("Italic"), this);
    ...
    m_actions[UnderlineAction] = new QAction(QPixmap(":/trolltech/formeditor/images/win/textunder.png"), tr("Underline"), this);
    ...
    al = new QAction(QPixmap(":/trolltech/formeditor/images/win/textleft.png"), tr("Align left"), this);
    ar = new QAction(QPixmap(":/trolltech/formeditor/images/win/textright.png"), tr("Align right"), this);
    ac = new QAction(QPixmap(":/trolltech/formeditor/images/win/textcenter.png"), tr("Center"), this);
    aj = new QAction(QPixmap(":/trolltech/formeditor/images/win/textjustify.png"), tr("Justify"), this);
    ...
    li = new QAction(QPixmap("/usr/share/icons/crystalsvg/16x16/actions/player_playlist.png"), tr("List"), this);
    tb->addAction(li);
 ...
 */
void QwwRichTextEdit_::changeAlignment(QAction *a){
 ...
 */
void QwwRichTextEdit_::setBold(bool v){
    QTextCursor cur = textCursor();
    QTextCharFormat fmt;
 ...
 */
void QwwRichTextEdit_::setItalic(bool v){
    QTextCursor cur = textCursor();
    QTextCharFormat fmt;
    fmt.setFontItalic(v);
    cur.mergeCharFormat(fmt);
 ...
 */
void QwwRichTextEdit_::setUnderline(bool v){
    QTextCursor cur = textCursor();
    QTextCharFormat fmt;
 ...
 */
void QwwRichTextEdit_::setColor(const QColor &c)
{
    QTextCursor cur = textCursor();
    QTextCharFormat fmt;
    fmt.setForeground(c);
 ...
 * \internal
 */
void QwwRichTextEdit_::setFont_h(){
 ...
 */
void QwwRichTextEdit_::setFont(const QFont &f){
    QTextCursor cur = textCursor();
    QTextCharFormat fmt;
 ...
 */
void QwwRichTextEdit_::setList(bool v){
    QTextCursor cur = textCursor();
    if(v){
 ...
 */
void QwwRichTextEdit_::updateCurrentCharFormat(const QTextCharFormat &fmt){
 ...
 */
void QwwRichTextEdit_::updateCurrentBlockFormat(){
 ...
 * \internal
 */
bool QwwRichTextEdit_::event(QEvent *e){
 ...
 * \internal
 */
void QwwRichTextEdit_::resizeEvent(QResizeEvent *re){
...
void QwwRichTextEdit_::setOptions(QwwRichTextEdit_::Options opt)
{
    m_options = opt;
...
QwwRichTextEdit_::Options QwwRichTextEdit_::options() const
{
    return m_options;
}
 ...
 */
QAction * QwwRichTextEdit_::toolBarAction(Action act) const
{
 ...
 * \internal
 */
void QwwRichTextEdit_::contextMenuEvent(QContextMenuEvent * event)
{
